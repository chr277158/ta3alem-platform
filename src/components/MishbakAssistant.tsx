...
export default function MishbakAssistant({ userName }: { userName?: string }) {
  ...
  return (
    <div className="fixed bottom-0 left-2 z-40 flex flex-col items-start gap-1 w-40">
      <div className="bg-white/95 backdrop-blur-sm text-gray-800 px-4 py-3 rounded-2xl rounded-bl-none shadow-xl border border-blue-200 max-w-[160px] text-sm font-medium relative animate-fade-in-up">
      ...
      <div 
        className="w-40 h-40 rounded-t-2xl relative overflow-hidden cursor-pointer"
