          ...
          {AVAILABLE_GAMES.map((game) => {
            ...
            return (
              ...
              >
                ...
                {isUnlocked && <div className="mt-2 text-sm opacity-90">اضغط للعب</div>}
              </button>
            );
          })}
        </div>
        <div className="mt-8 text-center">
          <button onClick={() => router.push('/dashboard')} className="bg-gray-200 text-gray-700 px-8 py-3 rounded-xl font-bold hover:bg-gray-300 transition-all">
            🏠 العودة للرئيسية
          </button>
        </div>
      </div>
